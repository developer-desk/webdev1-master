...
/*
abstract class DBConnectorObj
{    
    public static function connect($connString=DBConnectionString);
    public static function closeConnection($connection);
}
*/
class DBConnectorMySQL /*extends DBConnectorObj */
{
    public static function connect($connString=DBConnectionString)
    {
        $conn = MYSQL_CONNECT($connString::$db_server, $connString::$db_user, $connString::$db_pwd) or die ("<H3>Server unreachable</H3>");    
        //$conn = null;
        if (!$conn) {
    ...
    public static function dbSelect($connString=DBConnectionString, $conn)
    {
...
abstract class DBStmtObj
{
    ...
    public function addParameter($parameter, $val, $datatype)
    {
        ...
        {
            $retVal =  "'" . $val . "'";                                                                                                                                                                &n bsp;                                                                                                                                                                &nb sp;                                                                                                                                                                &nbs p;                                                                                                                                                                  ;                                                                                                                                                                                                                                                                                                                                   & nbsp;                                                                                                                                                                &n bsp;                                                                                                                                                                &nb sp;                                                                                                                                                                &nbs p;                                                                                                                                                                  ;                                                                                                                                                                                                                                                                                                                                   & nbsp;                                                                                                                                                                &n bsp;                                                                                                                                                                &nb sp;                                               
        }
        if (!isset($val)||$val=="")
            $retVal = "null";
...
/*    public function addParameterHolder($parameter, $val, $datatype)
    {
        ...
        if ($datatype == DATATYPE::$char || $datatype==DATATYPE::$datetime || $datatype == DATATYPE::$varchar)
        {
            $retVal =  "'%s'";                                                                                                                                                                 ;                                                                                                                                                                                                                                                                                                                                   & nbsp;                                                                                                                                                                &n bsp;                                                                                                                                                                &nb sp;                                                                                                                                                                &nbs p;                                                                                                                                                                  ;                                                                                                                                                                                                                                                                                                                                   & nbsp;                                                                                                                                                                &n bsp;                                                                                                                                                                &nb sp;                                                                                                                                                                &nbs p;                                                                                                                                                                  ;                                                                                                                                                                                                                  
        } 
        $this->sqlParameterValues[] = $retVal;                              
        return $retVal;
    }
*/
    ...
    {
        return DBDAL::getConnection(self::$connectionName);
    }
    protected function connect2()
    {
        return DBDAL::getConnectionArr(self::$connectionName);
    }
...
/***
* CHANGES: 
* lines: 171, 242, 440, 444, 240, 253
* lines: 279,280, 197->201
* 
* 
* 
*/
