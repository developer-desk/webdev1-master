 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="paul@takethetime.ca";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="afamdient@yahoo.ca";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
