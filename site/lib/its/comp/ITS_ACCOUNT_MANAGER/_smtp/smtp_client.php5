...
class SMTP_CLIENT
{
    public static function sendEmail($emailTo, $nameTo, $emailFrom, $nameFrom, $emailReplyTo, $nameReplyTo, $emailSubject, $emailContent, &$SysMsg, $isHtmlContent=true)
    {
