...
include ITS_ROOT_DIR."/lib/its/comp/ITS_ACCOUNT_MANAGER/ITS_AccountManager.php5"; //itsCorrection: move this include to lib\its\comp\ITS_ACCOUNT_MANAGER\config.php
ITS_AccountManager::signOut();
?>